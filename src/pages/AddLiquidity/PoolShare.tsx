...
import { formatAmount, formatBalance, formatPercent, formatReserve } from "../../utils/format";
interface Props {
    token1Symbol: string,
    token0Symbol: string,
    ...
    <div className="container">
      <label className="flex flex-col items-center w-full gap-5 pt-5 h-36 p-7 input input-bordered rounded-3xl">
            ...
            <div className="flex gap-10 justify-evenly" >
                ...
                <div className="flex flex-col items-center">
                    <div className="font-bold">{formatBalance(amountLT)} </div>
                    <div className="text-sm"> Expected liquidity token </div>
                </div>
